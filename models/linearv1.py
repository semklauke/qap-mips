...
def solve(
    ...
    # enforce and on y
    model.addConstrs(y[loc1, loc2, f1, f2] >= x[loc1, f1] + x[loc2, f2] - 1 for loc1, loc2, f1, f2 in y.keys())
...
def solve_equiv(
    ...
    # enforce and on y
    c3 = model.addConstrs(y[loc1, loc2, f1, f2] >= x[loc1, f1] + x[loc2, f2] - 1 for loc1, loc2, f1, f2 in y.keys())
